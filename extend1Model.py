class extend1Model:
    def __init__(self):
        ...
        self.imagePath = 'modelsImages/extend1Model.png'

    def __repr__(self):
        return "Pierwsze rozszerzenie"
    ...
    def getParametersSeters(self):
        return [("X0",lambda z:self.setX(z),0.6),
                ...
                ("D",lambda x:self.setD(x),0.2),
                ("E",lambda x:self.setE(x),0),
                ("F",lambda x:self.setF(x),0),
                ("End:",lambda x:self.setEnd(x),100)]
